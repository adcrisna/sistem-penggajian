            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <form action="{{ route('karyawan.updateProfile') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group has-feedback">
                                <label>No HP :</label>
                                <input type="number" name="no_hp" class="form-control" value="{{ $karyawan->no_hp }}"
                                    required>
                            </div>
                            <div class="form-group has-feedback">
                                <label>Jenis Kelamin</label>
                                <select name="jk" class="form-control" required>
                                    <option value="Laki-Laki" {{ $karyawan->jk == 'Laki-Laki' ? 'selected' : '' }}>
                                        Laki-Laki
                                    </option>
